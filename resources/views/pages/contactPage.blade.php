...
<body>
    ...
    <!-- HERO SECTION --> 
    <div class="heroSection minHeroSection contactPage">
    ...
    <!-- CONTACT SECTION -->
    <div class="section contactSection container" id="contactPage">
        <div class="sectionContent flex">
            <div class="leftDiv">
                <div class="secTitle">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, aliquid ex blanditiis veniam officia reiciendis minus. Quaerat totam rerum consectetur.
                ...
                <div class="reservationsNumber flex">
                    ...
                    <div>
                        ...
                        <a href="tel:256-705-886-700">+ 65 6988 2364</a>
                    </div>
                </div>

                <div class="reservationsEmail flex">
                    <i class="uil uil-envelopes icon"></i>
                    <div>
                        <span class="subTitle">
                            Email Info
                        </span>
                        <span class="emailAddress">info@hotelhorizon.com</span>
                    </div>
                </div>

                <div class="address flex">
                    <i class="uil uil-map-marker-alt icon"></i>
                    <div>
                        <span class="subTitle">
                            Hotel Address
                        </span>
                        <span class="location">Plot 11, 13 Portal Lane, <br>Near Meru Petrol Station Entebbe Uganda.</span>
                    </div>
                </div>
            ...
            <div class="rightDiv">
                ...
                <form method="post" class="grid">
                     ...
                     <div class="singleField">
                        ...
                        <textarea name="message" id="message" placeholder="Enter message here" required></textarea>
                     </div>
                     <button class="btn bg">
                        Submit
                    </button>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide singleTestimony">
                        ...
                        <div class="clientDiv flex">
                            <div class="imgDiv">
                            <img src="./Assets/user (14).png" alt="Client Image">
                            </div>
                    ...
                    <div class="swiper-slide singleTestimony">
                        ...
                        <div class="clientDiv flex">
                            <div class="imgDiv">
                            <img src="./Assets/user (12).png" alt="Client Image">
                            </div>
                    ...
                    <div class="swiper-slide singleTestimony">
                        ...
                        <div class="clientDiv flex">
                            <div class="imgDiv">
                            <img src="./Assets/user (10).png" alt="Client Image">
                            </div>
                    ...
                    <div class="swiper-slide singleTestimony">
                        ...
                        <div class="clientDiv flex">
                            <div class="imgDiv">
                            <img src="./Assets/user (25).png" alt="Client Image">
                            </div>
    ...
    <section class="footer">
        ...
        <div class="mainContent grid">
            ...
            <div class="introDiv">
                ...
                <p>Most luxurious hotel in Entebbe Uganda.</p>
            ...
            <div class="address">
                ...
                <p>Plot 11, 13 Portal Lane, Near Meru Petrol Station Entebbe Uganda.</p>
